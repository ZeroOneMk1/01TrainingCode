...
def tokenize_text(lines:list, nlp:stanza.pipeline.core.Pipeline, common_words:list) -> dict: # dict[str, dict[str,Any]]
...
def parse_translate_result(raw_trans:str) -> dict: # dict[str,Any]
    """
